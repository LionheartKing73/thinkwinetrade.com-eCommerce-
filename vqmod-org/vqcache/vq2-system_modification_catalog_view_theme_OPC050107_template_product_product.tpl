...
<p><img class="navbar-profile-avatar img-circle" style="margin: 0px 5px; border: 1px solid rgb(204, 204, 204);" src="<?php echo $image_vendor; ?>"><b><?php echo $vendor; ?></b> <span style="color:#EC1F6B;margin-left:5px;"><img style="margin-right:10px; width:7%;" src="image/thropy.png" data-toggle="tooltip" data-html="true" data-original-title="<?php echo $text_vendor_rating_tooltip; ?>"><?php echo $vendor_rating;?></span> <?php if(isset($vendor_in_pallet)) { ?><br><span class="this-vendor-in-pallet"><label class="label <?php echo ($vendor_in_pallet['vendorLimitNotMet'] ? "label-danger" : "label-success"); ?>"><?php echo $vendor_in_pallet['qty']; ?></label></span><?php } ?></p>
