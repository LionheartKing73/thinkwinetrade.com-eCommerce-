...
class ControllerModuleMegaFilter extends Controller {
	...
	public function index( $setting ) {
		...
		//$t=microtime(true);
		$core = MegaFilterCore::newInstance( $this, NULL , $this->model_module_mega_filter->getHKDRate());
		$cache = NULL;
		...
		$data['getSymbolRight']	= 'HK$'; //$this->currency->getSymbolRight();
	...
	public function ajaxinfo() {
		...
		echo json_encode( MegaFilterCore::newInstance( $this, NULL, $this->model_module_mega_filter->getHKDRate() )->getJsonData($baseTypes, $idx) );
	}
