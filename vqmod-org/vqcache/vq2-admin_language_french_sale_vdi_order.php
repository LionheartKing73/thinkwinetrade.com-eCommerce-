...
$_['button_confirm_po'] = 'Confirmer ce Bon de Commande (PO)';
...
$_['text_products_confirmed'] = '<b> Votre prochaine étape </b> <br>Tous vos produits sont confirmés en stocks. Vous pouvez désormais confirmer votre Bon de Commande (PO) <b> en cliquant dans l\'onglet  "Historique" </b> de cette commande!';
$_['text_products_need_confirmation'] = '<b>PREMIERE ETAPE</b>
<br>
<br>
Si vous venez juste de recevoir ce Bon de Commande (PO), confirmez les stocks pour chaque produits puis confimez le PO. <br>
<br>Dans la partie "Produits". Cliquez sur "Disponible".';
$_['text_history_need_confirmation'] = 'Attention!!!<br>Pour confirmer ce Bon de Commande (PO), vous devez confirmer les stocks produits dans la partie "Produits"';
$_['text_history_ready_to_confirm'] = '<b> 2EME ETAPE! </b>
<br>
<br> 
Veuillez nous confirmer ce Bon de Commande rapidement  (PO) puis contactez votre transporteur pour un éventuel ramassage.';
$_['text_history_tracking_information'] = '<b> DERNIÈRE ÉTAPE DE CETTE COMMANDE </b> 
<br> <br> 
<i>Vous avez reçu un SMS pour la demande d\'expédition de cette commande! </i>
<i>Attention! cet action est requise qu\'au moment de l\'arrivée du transporteur </i> 
</br> </br> 
<b>1. Veuiller tout d\'abord créer une fiche "Transporteur" dans votre menu </b> 
<br> <br> 
<b>2. Si vous n\'avez pas encore contacté votre transporteur vous pouvez désormais arranger un pickup avant de compléter cet action </b> 
</br> </br> 
<b> 3. Instructions pour expédition auprès de votre transporteur pour notre entrepôt: </b> 
</br> <i> A l\'arrivé du transporteur, sur votre droite sélectionnez le transporteur avec son Numéro de Tracking/Suivi, puis confimez l\'expédition </i> </br></br>
<b>
4. En parallèle, veuillez joindre par courrier les documents suivant: 
</b>
<i> </br> 
a. La Facture Commerciale (3 exemplaires, date, tampon, signature)
</br> 
b. Le Packing List correspondant
</br>
c. Un RIB Bancaire
</i>

</br></br> à cet adresse:</br>
Thinkwinetrade.com</br>
Siège</br>
5 Rue Lafaurie</br>
31500 Toulouse, France</br>

sales@thinkwinetrade.com';
