...
class ControllerReportMVDVendorTransaction extends Controller { 
	...
	public function addPaymentRecord() {
		...
		if ($getOPs->row) {
			...
			$data['title'] = $this->language->get('text_txn_subject');
			$data['subject'] = $this->language->get('text_txn_subject');
			$subject = $data['subject'];
			$data['text_dear'] = $this->language->get('text_dear');
			$data['text_txn_body'] = sprintf($this->language->get('text_txn_body'), $order_id, $data['amount']);
			$data['text_txn_body1'] = $this->language->get('text_txn_body1');
