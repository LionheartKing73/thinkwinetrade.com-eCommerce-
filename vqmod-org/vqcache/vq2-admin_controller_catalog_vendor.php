	...
	private $error = array();
  	...
  	private function getList() {
		...
		foreach ($results as $result) {
			...
			$rating = $this->model_catalog_vendor->getTotalRatingsVendorsByVendorId($result['vendor_id']);
			...
			$data['vendors'][] = array(
				...
				'status_vendor_update' => $result['status_vendor_update'],
				'date_vendor_reminder_second' => $result['reminder_second_date'],
				'date_vendor_reminder_first' => $result['reminder_first_date'],
		...
		$data['column_company_id'] = $this->language->get('column_company_id');
