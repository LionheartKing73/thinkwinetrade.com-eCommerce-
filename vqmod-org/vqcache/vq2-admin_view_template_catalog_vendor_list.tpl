          ...
          <thead>
            <tr>
			  ...
			  <td class="text-left"><?php if ($sort == 'vendor_name') { ?>
                ...
                <td class="text-left"><?php echo $column_company_id; ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left"><?php echo $vendor['vendor_name']; ?></td>
                ...
                <td class="text-left"><?php echo $vendor['company_id']; ?></td>
            
              <td class="text-left"><?php echo $vendor['commission']; ?></td>
              <td class="text-left"><?php echo $vendor['total_products']; ?></td>
              <td class="text-left"><?php echo $vendor['status']; ?>
              <?php if($vendor['status_vendor_update'] != 1 && $vendor['notification'] == 1){ ?>
                		   <br>
                        <div class="label label-warning" style="text-align:center; padding:1px;">
                        	Not Update Yet
                            <br>
                         <?php echo date('d-m-Y', strtotime($vendor['date_vendor_reminder_second']));?>
                     	</div>
                <?php } ?></td>
              <td class="text-left"><?php echo $vendor['rating']; ?></td>
