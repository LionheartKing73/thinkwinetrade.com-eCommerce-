...
$data['text_pallet'] = $this->language->get('text_pallet');
      ...
      $data['text_vendor_carriers'] = $this->language->get('text_vendor_carriers');
    ...
    $data['pallet'] = $this->url->link('sale/pallet', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['rating'] = $this->url->link('catalog/rating', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['wine_rating'] = $this->url->link('module/ratings', 'token=' . $this->session->data['token'], 'SSL');
      ...
      $data['mvd_vendor_carriers'] = $this->url->link('module/mvd_carriers', 'token=' . $this->session->data['token'], 'SSL');
