      ...
      <table class="table table-bordered table-hover">
        <thead>
          <tr>
            ...
            <td class="text-right"><?php echo $column_price_bottle; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><?php if ($product['price']) { ?>
              ...
              <?php } ?></td>
             <td class="text-right"><?php if ($product['price_bottle']) { ?>
              <div class="price">
                <?php if (!$product['special_bottle']) { ?>
                <?php echo $product['price_bottle']; ?>
                <?php } else { ?>
                <b><?php echo $product['special_bottle']; ?></b><br /><s><?php echo $product['price_bottle']; ?></s>
                <?php } ?>
              </div>
              <?php } ?></td>
             <td class="text-right"><?php if ($product['hk']) { ?>
              <div class="price">
                <?php if (!$product['special_hk']) { ?>
                <?php echo $product['hk']; ?>
                <?php } else { ?>
                <b><?php echo $product['special_hk']; ?></b><br /><s><?php echo $product['hk']; ?></s>
                <?php } ?>
              </div>
              <?php } ?></td>
            <td class="text-right">
             ...
             -->
             <button type="button" onclick="addproductaction('<?php echo $product["product_id"]; ?>', '<?php echo str_replace("'", "\\'", $product['name']); ?>'); return false;" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button>
