  ...
  <div class="row content-subinner"><?php echo $column_left; ?>
    ...
    <ul class="left product-image thumbnails">
	  ...
	  <!-- Megnor Cloud-Zoom Image Effect Start -->
	  	<li class="image">
		 <?php if ($fakeprice > 0): ?>
            <div class="ribbon"><span> - <?php echo $fakeprice; ?>%</span></div>
        <?php endif; ?>
		<a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
      <?php } ?>
      <?php if ($images) { ?>
	  	 <?php
			$sliderFor = 3;
