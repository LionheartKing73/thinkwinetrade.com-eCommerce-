        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php if ($products[$product['product_id']]['price']) { ?>
              ...
              <?php } else { ?>
             <strike><?php echo $products[$product['product_id']]['price']; ?></strike><br />
          ...
          <tr>
            <td><?php echo $text_price_bottle; ?></td>
            <?php foreach ($products as $product) { ?>
            <td><?php if ($products[$product['product_id']]['price_bottle']) { ?>
              <?php if (!$products[$product['product_id']]['special_bottle']) { ?>
              <?php echo $products[$product['product_id']]['price_bottle']; ?>
              <?php } else { ?>
             <strike><?php echo $products[$product['product_id']]['price_bottle']; ?></strike><br />
              <?php echo $products[$product['product_id']]['special_bottle']; ?>
              <?php } ?>
              <?php } ?></td>
            <?php } ?>
          </tr>
          <tr>
            <td>HK$</td>
            <?php foreach ($products as $product) { ?>
            <td><?php if ($products[$product['product_id']]['hk']) { ?>
              <?php if (!$products[$product['product_id']]['special_hk']) { ?>
              <?php echo $products[$product['product_id']]['hk']; ?>
              <?php } else { ?>
             <strike><?php echo $products[$product['product_id']]['hk']; ?></strike><br />
              <?php echo $products[$product['product_id']]['special_hk']; ?>
              <?php } ?>
              <?php } ?></td>
            <?php } ?>
          </tr>
