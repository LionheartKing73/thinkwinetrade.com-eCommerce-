            ...
            <div class="form-group quntity">
              ...
              <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
                            ...
                            <div class="button-group pro-button">
                              ...
                              <button class="wishlist greenBtn" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-pencil-square-o"></i></button>
...
<?php endif; ?>
                   ...
                   <?php } else {?>
					...
					<button type="button" class="compare" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
					  <button type="button" class="wishlist" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-pencil-square-o"></i></button>
					</div>
                      <?php } ?>
					</div>
