          ...
          <div class="sc-child-wrapper">
            ...
            <div class="<?php echo $subitems_carousel ? 'sc-carousel sc-theme' : 'subitem-wrapper'; ?>">
              ...
              <div class="item-container">
                <div class="item-wrapper img-<?php echo $subitem_img_pos; ?><?php echo $subitem['active'] ? ' active' : ''; ?>">
...
<?php if ($items_carousel) { ?>
  ...
  <?php if ($autoplay) { ?>
    $('#sс-<?php echo $module; ?> .sc-child').hover(function(){
      itemscarousel.trigger('stop.scc.autoplay');
    });
  <?php } ?>
  <?php if ($subitems_carousel) { ?>
    ...
    $('#sс-<?php echo $module; ?> .parent-item').each(function(i) {
      ...
      $('#sс-<?php echo $module; ?> .sc-toggle-'+(i+1)).find('a').not('.item-btn a').on('click', function() {
        ...
        <?php if ($scrolltop) { ?>
        var target_offset = target.parent().offset().top;
        if (target.is(':hidden')) {
          $('body,html').animate({scrollTop: target_offset-10},<?php echo $scrolltop_speed; ?>);
        }
        <?php } ?>
  ...
  <?php } else { ?>
    ...
    function dimension(){
      ...
      subrow.find('.subitem-wrapper').css('margin-right','-<?php echo $subitem_margin+1; ?>px');
      ...
      $(subrow).each(function() {
        ...
        for (var i = 0; i < subiteminrow.length; i+=subitem_count) {
          ...
          var subrow_width = $(this).find('.sc-child-wrapper').width()+<?php echo $subitem_margin; ?>;
          var subitem_width = 0;
          ...
          <?php if ($subitem_img_pos == 'bottom') { ?>
            var subheading = childrow.find('.item-heading');
...
<?php } else { ?>
  ...
  function dimension(){
    $('#sс-<?php echo $module; ?> .sc-grid').each(function() {
      ...
      for (var i = 0; i < items.length; i+=item_count) {
        ...
        $(this).find('.sc-items-row').css('margin-right','-<?php echo $item_margin+1; ?>px').detach(':empty');
      ...
      $(this).find('.sc-child').each(function() {
        ...
        for (var i = 0; i < subiteminrow.length; i+=subitem_count) {
          ...
          // if (childrow.length < subitem_count) {
          //   sml = (subrow_width-(subitem_width+<?php echo $subitem_margin; ?>)*childrow.length)/2;
          // }
  ...
  $('#sс-<?php echo $module; ?> .parent-item').each(function(i) {
    ...
    $('#sс-<?php echo $module; ?> .sc-toggle-'+(i+1)).find('a').not('.sc-child a,.item-btn a').on('click', function() {
      <?php if ($subitems_carousel) { ?>
        if ($(subcarousel).is(':hidden')) {
            target.show();
            subcarousel.trigger('refresh.scc.carousel');
