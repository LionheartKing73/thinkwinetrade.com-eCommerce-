<?php echo $header; ?>
    ...
    <div class="row">
        ...
        <section id="content" class="<?php echo $main; ?> home">
        ...
        <div class="container">
            ...
            if(isset($language_id)) { 
                ...
                if($config->get('aslider_general_status') == '1') { ?>
                ...
                <div class="fullwidthbanner-container">
                    <div class="fullwidthbanner">
                        ...
                        <?php 
                            ...
                            for ($i = 1; $i <= $config->get('aslider_slides_qty'); $i++) { 
                                                
                                $slider = $config->get('aslider'); 
                                ...
                                if(isset($slider[$i][$language_id]['status'])) {
                                    ...
                                    if($slider[$i][$language_id]['status'] == '1') {
                                        ...
                                        for ($m = 1; $m <= $config->get('aslider_elements_qty'); $m++) {
                ...
                <style type="text/css">
                    ...
                    .fullwidthbanner-container { max-height:<?php echo $config->get('aslider_height'); ?>px !important; }
                </style>
            ...
            <script type="text/javascript">
                ...
                if ($.fn.cssOriginal!=undefined)
                    ...
                    $('.fullwidthbanner').revolution({
                        delay:<?php echo $config->get('aslider_delay')*1000; ?>,
                        <?php $layout = $config->get('main_layout'); ?>

                        startwidth:<?php echo ($layout=='large') ? '1140' : '960';  ?>,
                        startheight:<?php echo $config->get('aslider_height'); ?>,
                        ...
                        shuffle:"<?php echo ($config->get('aslider_shuffle_slides')==1) ? 'on' : 'off'; ?>",
