 <?php if ($error_warning) { ?>
  ...
  <?php } ?>
<div id="registration" class="register-container register col-sm-12" style="padding-right:0px;display:none">
				<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
				<div class="loginlogo">
					<a href="<?php echo $home; ?>"><img src="<?php echo $rlogo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" width="100" height="100"/></a>
				</div>
				<?php if($socialstatus==1){?>				
				<div class="col-sm-12 <?php if($socialarea=='top'){?> social<?php } else { ?> hide<?php } ?> ">
					<div class="socialtitle"><?php echo $socialtitle;?></div>
				...
				<h2 class="registerbox"><?php echo $entry_accounttitle; ?></h2>
					...
					<div class="col-sm-6 form-group">
					 <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $city_lable;?>" id="input-city" class="form-control" /></div>
					<?php } ?>
				...
				<div class="col-sm-12 form-group">
					<span class="privacy"><?php echo $text_agree; ?></span>
					 <?php if ($agree) { ?>					
	...
	<div id="login" style="display:block"  class="login-container login col-sm-12">
		<form  action="" method="post" enctype="multipart/form-data" class="form-horizontal">
			<div class="loginlogo">
				<a href="<?php echo $home; ?>"><img src="<?php echo $rlogo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" width="100" height="100"/></a>
			</div>
	...
	<div id="forgotten" style="display:none"  class="forgotten-container forgotten col-sm-12">
			...
			<div class="form-group">
				<div class="col-sm-12" style="margin-top:10px">
					<div class="pull-left">
					<a style="padding:10px;" class="click btn btn-default" rel="login" rel1="registration" rel2="forgotten"><?php echo $button_back; ?></a>	
					</div>
