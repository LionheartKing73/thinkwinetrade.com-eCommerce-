<div class="block-inner block-container block-pricing-table col-md-offset-<?php echo $offset; ?> col-md-<?php echo $size; ?> level<?php echo $level; ?> 
    ...
    <?php } ?>
<style>
#<?php echo $key; ?>.block-inner.block-container > .block-pricing-table-content > .block-container{
    margin-right: <?php echo $setting['width_between']; ?>;
}
#<?php echo $key; ?>.block-inner.block-container > .block-pricing-table-content > .block-container:last-child{
    margin-right: 0px;
}
