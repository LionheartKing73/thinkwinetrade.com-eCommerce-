var conversion_base = {
    ...
    addConversion:function(description_id, type){
        ...
        if(this.log[description_id][type] == undefined){
            ...
            $.ajax({
                url:'index.php?route=d_visual_designer_module/conversion/addConversion',
                type:'post',
                dataType:'json',
                data: send_data,
    ...
    addConversionBuy:function(description_id, product_id){
        ...
        if(this.log[description_id]['buy'] == undefined){
            ...
            $.ajax({
                url:'index.php?route=d_visual_designer_module/conversion/addConversionBuy',
                dataType:'json',
                type:'post',
                data:send_data
            });
