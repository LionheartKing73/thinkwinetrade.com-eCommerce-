...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
		...
		//Th-add
		/* if(isset($this->session->data['order_id'])){//Truong hop cancel payment trong khi thanh toan, order luc nay da dc tao lai, nen can them pallet moi cho no
			...
			if($pallets < $this->config->get('pallets_limit_c')) {
				$this->model_pallet_worksheet->addPallet($worksheet_id, $customer_id);
			}
		}*/
		//End Th-add
