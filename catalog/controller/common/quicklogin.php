...
class ControllerCommonQuicklogin extends Controller {
	...
	if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/quicklogin.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/quicklogin.tpl', $data);
		} else {
			return $this->load->view('default/template/common/quicklogin.tpl', $data);
		}
	}
}