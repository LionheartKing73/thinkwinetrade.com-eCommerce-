...
*/
    	...
    	$rt =  $this->request->get['route']; // fix for vd routes issue wich is caused somewhere inside controller/common/layout_header/layoutPositions
		...
		/* Tmd Quick Login-Register */
    	$this->request->get['route'] = $rt; // fix for vd routes issue end
