...
class ControllerDVisualDesignerModuleGallery extends Controller {
	...
	public function index($setting){
		...
		if (file_exists(DIR_TEMPLATE . $this->theme . '/stylesheet/d_visual_designer/gallery/gallery.css')) {
			$this->document->addStyle('catalog/view/theme/'.$this->theme.'/stylesheet/d_visual_designer/gallery/gallery.css');
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/d_visual_designer/gallery/gallery.css');
		}
	...
	public function setting($setting){
		...
		$data['images'] = array();
		foreach ($data['setting']['images'] as $image) {
