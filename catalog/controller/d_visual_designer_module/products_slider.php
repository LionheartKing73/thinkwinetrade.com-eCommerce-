...
class ControllerDVisualDesignerModuleProductsSlider extends Controller {
    ...
    public function index($setting){
        ...
        switch ($data['setting']['mode']) {
            case 'latest':
            $products = $this->model_d_visual_designer_module_products_slider->getLatestProducts($data['setting']['count_product']);
            break;
            
            case 'special':
            $products = $this->model_d_visual_designer_module_products_slider->getProductSpecials($data['setting']['count_product']);
            break;
            
            case 'popular':
            $products = $this->model_d_visual_designer_module_products_slider->getPopularProducts($data['setting']['count_product']);
            break;
            case 'bestseller':
            $products = $this->model_d_visual_designer_module_products_slider->getBestSellerProducts($data['setting']['count_product']);
            break;
