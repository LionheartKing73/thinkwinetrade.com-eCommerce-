...
class ModelCatalogShowcase extends Model {
	public function getShowcaseCategory($category_id) {
		return $this->getShowcaseCategories((int)$category_id, 'by_id');
	}

	public function getShowcaseCategories($id = 0, $type = 'by_parent') {
		static $data = null;
