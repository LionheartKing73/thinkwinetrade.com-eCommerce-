...
$_['text_checkout_shipping_method'] = '第 4 步： 配送方式';
...
$_['text_guest'] = '直接结账';
$_['text_register_account'] = '请注册一个账户以便您更快捷的购物， 查看订单状态， 查看采购的历史记录， 和更多的管理项目。';
...
$_['entry_country'] = '国家：';
$_['entry_zone'] = '地区 / 省份：';
$_['entry_newsletter'] = '我希望订阅 %s 资讯。';
$_['entry_shipping'] = '我的配送地址和帐单地址相同。';
$_['entry_account'] = '帐号:';
$_['entry_company_id'] = '公司注册号:';
$_['entry_tax_id'] = '公司税号:';
$_['error_warning'] = '在结算时出现了问题！ 如果此问题继续存在请使用其它支付方式或<a href="%s">联系我们</a>。';
$_['error_login'] = '警告： 邮件地址或密码不符。';
$_['error_approved'] = '警告: 您的帐号还没有通过审核！';
$_['error_exists'] = '警告： 该邮箱地址已被注册、请更换电子邮箱！';
...
$_['error_no_shipping'] = '警告：无可用货运方式。 请<a href="%s">联系我们</a> 以获取帮助！';
