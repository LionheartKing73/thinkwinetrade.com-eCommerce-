<?php
$_['heading_title'] = '产品退换';
$_['text_account'] = '账户';
$_['text_return'] = '退换资料';
$_['text_return_detail'] = '退换信息';
$_['text_description'] = '<p>请完整填写下表，并获取RMA号码。</p>';
$_['text_order'] = '订单信息';
$_['text_product'] = '产品信息 & 退换原因';
$_['text_message'] = '<p>感谢您提交退换信息。 您的请求已经发送到相关部门处理。</p><p> 我们将通过邮件通知您相关退换安排。</p>';
$_['text_return_id'] = '退换号码：';
$_['text_order_id'] = '订单号码：';
...
$_['entry_product'] = '产品名称';
$_['entry_model'] = '产品型号：';
$_['entry_quantity'] = '数量：';
$_['entry_reason'] = '退换原因：';
$_['entry_opened'] = '产品已开封：';
...
$_['error_product'] = '产品名称必须在3-255字符之间。';
$_['error_model'] = '产品名称必须在3-64字符之间。';
$_['error_reason'] = '请选择一个退换原因。';
$_['error_captcha'] = '验证码与图像的验证号码不一致。';
$_['error_name'] = '产品名称必须在3-255字符之间。';
$_['error_agree'] = '警告：您必须同意%s条款！';
?>