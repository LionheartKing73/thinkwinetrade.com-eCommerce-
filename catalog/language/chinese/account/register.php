<?php
$_['heading_title'] = '如果您的业务是在香港，就在今天跟我们注册一个合伙的帐户！';
$_['text_account'] = '我的账户';
$_['text_register'] = '用户注册';
$_['text_account_already'] = '如果您已经是本站的会员，请您直接<a href="%s">登录</a>。';
...
$_['error_agree'] = '警告： 您必须同意条款 %s！';
$_['error_company_id'] = '公司注册号！';
$_['error_tax_id'] = '公司税号必填！';
$_['error_vat'] = '无效的增值税号码！';
$_['error_company'] = '公司名称必须在2到32字节之间！';
$_['text_regpage'] = 'Registration page.';
$_['text_noaccount'] = 'If you have no account , click';
?>