...
$_['text_login']             = '注意： 請<a href="%s">登錄</a> 或 <a href="%s">註冊賬號</a> 才能查看價格！';
...
$_['text_month']             = '月';
$_['text_year']              = '年';
$_['text_trial']       			 = '%s 每 %s %s 為 %s 付款然後 ';
$_['text_recurring']   			 = '%s 每 %s %s';
$_['text_length']      			 = ' 為 %s 付款';
$_['text_until_cancelled']   = '直到取消';
$_['text_recurring_item']    	              = '分期項目';
$_['text_payment_recurring']                = '分期付款';
$_['text_trial_description'] 	              = '%s 每 %d %s(s) 為 %d 付款然後';
$_['text_payment_description'] 	              = '%s 每 %d %s(s) 為 %d 付款';
...
$_['error_recurring_required'] = '請選擇分期付款！';