...
$_['text_history']                            = 'Action sur cette Commande';
...
$_['text_noactions']                          = 'Nous vous remercions pour votre collaboration rapide. Cette commande est terminée, aucune action est nécessaire à ce stade du traitement, le paiement vous sera versé des reception des colis à notre entrepot et la validation de tous les documents.';
...
$_['text_products_confirmed']                 = 'Tous vos produits sont confirmés en stocks. Vous pouvez désormais confirmer votre Bon de Commande (PO) dans la partie "Historique" de la commande!';
$_['text_products_need_confirmation']         = 'Si vous venez juste de recevoir ce Bon de Commande (PO), ils vous faut d\'abord confirmer les stocks pour l\'Envoi de chaque produit dans la partie "Produits". Cliquer sur "Disponible".';
$_['text_history_need_confirmation']          = 'Pour confirmer ce Bon de Commande (PO), vous devez confirmer les stocks produits dans la partie "Produits"';
$_['text_history_ready_to_confirm']           = 'Vous pouvez désormais confirmer ce Bon de Commande (PO) >>>';
$_['text_history_tracking_information']       = 'Attention! cet action est requise qu\'au moment de l\'arrivée du transporteur. Si vous n\'avez pas encore contacté votre transporteur vous pouvez désormais arranger un pickup avant de compléter cet action. Instructions pour expédition auprès de votre transporteur pour notre entrepot: Insérez le nom de l\'entreprise de transport avec son Numéro de Tracking/Suivi, puis confimez!. (Documents) (Documents) (Documents) (Documents) adresse!!';
$_['text_field_transporter']                  = 'Nom de L\'Entreprise de Transport';
$_['text_field_ref_number']                   = 'Numéro Tracking/Suivi';
$_['shipping_by_myself']                      = 'Je transporte moi même les produits à l\'entrepot';
$_['text_choose_shipping']                    = 'Sélectionner votre transporteur';

$_['column_confirmed']                        = 'Confirmation Stock';
