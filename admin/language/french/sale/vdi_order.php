...
$_['text_list'] = 'Liste de mes Commandes';
$_['text_add'] = 'Add Order';
$_['text_edit'] = 'Editer la Commande';
$_['text_order_detail'] = 'Détails de la Commande (Order Details)';
$_['text_order_id'] = 'ID Commande:';
$_['text_invoice_no'] = 'Facture N°:';
$_['text_invoice_date'] = 'Date Facturation:';
...
$_['text_total'] = 'Total TTC';
$_['text_reward'] = 'Reward Points:';
$_['button_packing_list_print'] = 'Imprimer le Packing List';
$_['text_order_status'] = 'Statut Commande:';
...
$_['text_date_modified'] = 'Modifié le';
...
$_['text_from'] = 'EXPEDITEUR (sender)';
$_['text_to'] = 'DESTINATAIRE (recipient)';
...
$_['text_order'] = 'Détail de la Commande';
...
$_['text_error'] = 'Error:';
$_['text_picklist'] = 'Packing List Order';
$_['text_history'] = 'Gérer Cette Commande';
$_['text_pending_other_vendor'] = '<br/><small>Pending others vendor to change order status to <b>%s</b> before email notification sent to customer</small>';
$_['text_pending_vendor'] = '<br/><small>Pending vendor to change order status to <b>%s</b> before email notification sent to customer</small>';
$_['text_default_store'] = 'Default Store';
$_['text_total_weight'] = 'Poid Total de la Palette';
$_['text_total_cases'] = 'Total Carton(s)';
$_['text_note'] = 'Note';
$_['text_tracking_no'] = 'Tracking:';
$_['text_carrier'] = 'Transporteur: -';
$_['text_nof_prod'] = 'Nombre de Prod# pour cette Commande: +';
$_['text_nof_pallet'] = 'Nombre de Palette pour cette Commande: +';
$_['text_pal_total_prod'] = 'Nombre de Prod# pour cette Palette: +';
$_['text_vintage'] = 'Couleur<br/>Millésime';
$_['text_wh_contact'] = 'Warehouse Contact:';
$_['text_store_contact'] = 'Store Contact:';
$_['text_wh_info'] = 'INFORMATION POUR ENTREPOT (Préparation Palettes)';
...
$_['column_product'] = 'Produits';
$_['column_model'] = 'Modèle';
$_['column_quantity'] = 'Quantité
<br>
cartons';
$_['column_price'] = 'Prix par Carton';
$_['column_comment'] = 'Commentaires et suivi';
$_['column_notify'] = 'Client Notifié';
$_['column_location'] = 'Localisation';
$_['column_reference'] = 'Référence';
$_['column_action'] = 'Action';
$_['column_weight'] = 'Poid Produit';
$_['column_products'] = 'Produits';
$_['entry_store'] = 'Store';
...
$_['entry_order_id'] = 'ID Commande';
$_['text_subtotal'] = 'Sous Total (Achat - TVA 20%)';
...
$_['button_send_po'] = 'Envoi PO aux Producteurs';
$_['column_product_no'] = 'Ref. Prod#';
$_['button_confirm'] = 'Disponible';
$_['button_confirm_po'] = 'J\'ai Les Produits en Stock Et Je Confirme Ce Bon de Commande (PO)';
$_['button_confirm_shipping'] = 'Confirmer l\'Envoi des Colis Auprès de Votre Transporteur';
$_['text_confirmed_no'] = 'Non Confirmé';
$_['text_confirmed_yes'] = 'En Stock';
$_['text_noactions'] = '<b>MERCI! VOTRE COMMANDE EST COMPLÈTE</b>
<br>
<br>
Nous vous remercions pour votre collaboration rapide.
<br>
Cette commande est terminée, aucune action est nécessaire à ce stade du traitement de la commande.
<br>
Le paiement total de la commande vous sera versé des réception des colis à notre entrepôt et la validation de tous les documents.
<br>
<br>
Important!!! Veuillez imprimer le Packing List qui accompagnera les produits pendant le transport.
<br>
<br>
<b>Encore une fois! document à envoyer par courrier: </b>
<br>
<br>
<i>3 Copies de la Facture Commerciale (date, tampon, signature)</i>
<br>
<i>1 Packing List</i>
<br>
<i>1 RIB de votre banque</i>';
$_['text_wait_po_confirm'] = 'Cette commande est en attente des confirmations des autres producteurs présents sur la commande. Une notification vous sera envoyée pour expédier les colis a notre entrepot!';
$_['text_products_confirmed'] = '<b> Votre prochaine étape </b> <br>Tous vos produits sont confirmés en stocks. Vous pouvez désormais <b>Confirmer votre Bon de Commande (PO) </b> en cliquant dans l\'onglet  <b>HISTORIQUE</b> de cette commande! <i class="fa fa-check" aria-hidden="true"></i>
';
$_['text_products_need_confirmation'] = '<p><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><strong>1ERE ETAPE</strong> <br /> Si vous venez juste de recevoir ce Bon de Commande (PO), confirmez les stocks pour chaque produits puis confimez le PO. <br /> <br />Dans l\'onglet <strong>PRODUIT</strong> puis cliquez sur <strong>DISPONIBLE</strong>.</p>
<p>Cliquez sur <strong>AIDE</strong> pour plus d\'information.</p>';
$_['text_history_need_confirmation'] = '<p><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><strong>ATTENTION!!!</strong></p>
<p>Pour confirmer ce Bon de Commande (PO), vous devez d\'abord confirmer les stocks produits dans l\'onglet <strong>PRODUITS</strong></p>';
$_['text_history_ready_to_confirm'] = '<i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
<b> 2EME ETAPE! </b>
<br>
<br>
Veuillez nous <b>Confirmer ce Bon de Commande rapidement (PO)</b> puis contactez votre transporteur pour un éventuel ramassage.';
$_['text_history_tracking_information'] = '<p><strong>DERNIÈRE ÉTAPE DE CETTE COMMANDE </strong> <br /> <br /> <em>Vous avez reçu un SMS pour la demande d\'expédition de cette commande! </em> <em>Attention! cet action est requise qu\'au moment de l\'arrivée du transporteur </em></p>
<p><strong>1. <strong>Si vous n\'avez pas encore contacté votre transporteur vous pouvez désormais arranger un ramassage avant de compléter cet action, Puis attendez l\'arrivée de vore transporteur pour ouvrir cette interface encore une fois</strong></strong></p>
<p><strong>2. Référencez votre<strong> <a href="https://thinkwinetrade.com/admin/index.php?route=module/vdi_my_carriers">"Transporteur"</a> dans votre menu </strong><br /></strong></p>
<p><strong> 3. Instructions pour expédition auprès de votre transporteur pour notre entrepôt: </strong> <em> A l\'arrivé du transporteur, sélectionnez le transporteur avec son Numéro de Tracking/Suivi, puis confimez l\'expédition </em></p>
<p><strong> 4. Par courrier, veuillez joindre les documents suivant: </strong></p>
<p><em> a. </em>La Facture Commerciale<em> (3 exemplaires, date, tampon, signature) </em></p>
<p><em> b. </em>Le Packing List correspondant</p>
<p><em> c. </em>Un RIB Bancaire à cet adresse: <em>Thinkwinetrade.com Siège Joulin-Villemur, 31420 Boussan, France </em></p>
<p><span style="color: #808080;">Envoyez-nous un mail pour assistance: sales@thinkwinetrade.com</span></p>';
$_['text_field_transporter'] = 'Nom de L\'Entreprise de Transport';
$_['text_field_ref_number'] = 'Numéro Tracking/Suivi';
$_['shipping_by_myself'] = 'Je transporte moi même les produits à l\'entrepôt';
$_['text_choose_shipping'] = '- Sélectionner votre transporteur -';
$_['column_confirmed'] = 'Confirmation</br> Stock';
$_['tooltip_history'] = 'Confirmer ce bon de commande';
$_['tooltip_products'] = 'Il y a des produits a confirmer!';
$_['tooltip_no_action'] = 'Commande Complète!';
$_['tooltip_truck'] = 'Il y a une commande à expédier!';
$_['column_pallet_no'] = 'Pallet ID';
$_['unfinished_orders'] = 'Commandes en cours';
$_['finished_orders'] = 'Commandes terminées';
$_['text_vat'] = 'ACHAT - TVA 20%';
?>