...
$_['text_success']          = 'Succès: Vous avez modifié la livraison par United States Postal Service !';
$_['text_edit']             = 'Modifier la livraison par United States Postal Service';
...
$_['entry_display_weight']  = 'Afficher le poids de livraison';
$_['entry_weight_class']    = 'Classe de poids';
$_['entry_tax']             = 'Classe de taxes';
$_['entry_geo_zone']        = 'Zone géographique';
$_['entry_status']          = 'Statut';
$_['entry_sort_order']      = 'Classement';
$_['entry_debug']           = 'Mode de débuggage';

// Help
$_['help_dimension']        = 'Dimensions moyennes de paquet pour l\'emballage de livraison. Les dimensions de produit ne sont pas utilisées actuellement pour la livraison.';
$_['help_display_time']     = 'Voulez-vous afficher le délai de livraison ? (ex. Livraison en 3 à 5 jours)';
$_['help_display_weight']   = 'Voulez-vous afficher le poids de livraison? (ex. Poids livré: 2.7674 kg)';
$_['help_weight_class']     = 'Positionner sur livres.';
$_['help_debug']            = 'Enregistre les données send/recv dans le journal système.';

// Error
$_['error_permission']      = 'Attention: Vous n\'avez pas les droits nécessaires pour modifier la livraison par United States Postal Service !';
$_['error_user_id']         = 'ID Utilisateur requis !';
