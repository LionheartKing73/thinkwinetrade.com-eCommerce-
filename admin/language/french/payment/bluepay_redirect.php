<?php
// Heading
$_['heading_title']          = 'BluePay Redirect (nécessite SSL)';

// Text
$_['text_payment']           = 'Paiement';
$_['text_success']           = 'Succès: Vous avez modifié les détails de paiement par BluePay Redirect !';
$_['text_edit']              = 'Modifier le paiement par BluePay Redirect (Requires SSL)';
...
$_['text_release_ok_order']  = 'Votre paiement a été émis avec succès !';
...
$_['help_transaction']       = 'La méthode de transaction DOIT être positionnée sur Paiement pour permettre les paiements par abonnement';
...
// Error
$_['error_permission']       = 'Attention: Vous n\'avez pas les droits nécessaires pour modifier le paiement par BluePay!';
$_['error_account_id']       = 'N° du compte requis !';
