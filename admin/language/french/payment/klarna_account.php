...
$_['text_success']          = 'Succès: Vous avez modifié les détails de paiement par Klarna !';
$_['text_edit']             = 'Modifier le paiement par Klarna';
...
// Entry
$_['entry_merchant']        = 'ID Marchand Klarna';
...
// Help
$_['help_merchant']         = '(estore id) à utiliser pour le service Klarna (fourni par Klarna).';
$_['help_secret']           = 'Secret partagé à utiliser avec le service Klarna (fourni par Klarna).';
$_['help_total']            = 'Le total à l\'encaissement que la commande doit atteindre avant que ce mode de paiement devienne actif.';

// Error
$_['error_permission']      = 'Attention: Vous n\'avez pas les droits nécessaires pour modifier le paiement par compte Klarna !';
...
$_['error_log']             = 'Des erreurs sont survenues lors de la mise à jour du module. Veuillez vérifier le journal des erreurs.';
?>