...
// Help
$_['help_address_format']     = '名字 = {firstname}<br />姓氏 = {lastname}<br />公司 = {company}<br />地址 1 = {address_1}<br />地址 2 = {address_2}<br />城市 = {city}<br />郵編 = {postcode}<br />國家地區 = {zone}<br />地區編碼 = {zone_code}<br />國家 = {country}';
...
$_['error_address']          = '警告： 該國家不能刪除，因為被綁定到 %s 收貨地址記錄！';
$_['error_affiliate']        = '警告： 該國家不能刪除，因為被綁定到 %s 加盟會員！';
