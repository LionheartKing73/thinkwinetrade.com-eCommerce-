...
$_['button_confirm_po']                       = 'Confirm this PO';
$_['button_confirm_shipping']                 = 'Confirm Shipping';

$_['text_confirmed_no']                       = 'No';
$_['text_confirmed_yes']                      = 'Yes';
$_['text_noactions']                          = 'There are currently no actions required';
$_['text_wait_po_confirm']                    = 'Waiting for other Vendors to Confirm PO';
$_['text_products_confirmed']                 = 'You have Confirmed all you products, you can now proceed to Confirm this PO in "History" tab.';
$_['text_products_need_confirmation']         = 'If you have just received this PO, you need to Confirm the stock first. Do it by pressing Confirm button next to each product.';
$_['text_history_need_confirmation']          = 'To Confirm this PO, you need to Confirm the stock first in "Products" tab.';
$_['text_history_ready_to_confirm']           = 'Ready to Confirm >>>';
$_['text_history_tracking_information']       = 'DEAR VENDOR, YOU CAN NOW PROCEED';
$_['text_field_transporter']                  = 'Transporter\'s name';
$_['text_field_ref_number']                   = 'Shipping REF number';
$_['shipping_by_myself']                      = 'Shipping By Myself';
$_['text_choose_shipping']                    = ' - Choose shipping - ';

$_['column_confirmed']                        = 'Confirmed';
