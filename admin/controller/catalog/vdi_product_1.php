...
*/
	...
	/*	
        ...
        $discount_steps = array(12,24,48,72,92,198,298,398,498,500);
        ...
        if (count ($product_discounts)){
                foreach ($product_discounts as $product_discount) {
                    if ($curr_qty != $product_discount['quantity']){
                            ...
                            $data['product_discounts'][] = array(
                                ...
                                'bottle_price'      =>  $this->currency->format($product_discount['sp_price']),
                                'price'             =>  $this->currency->format($product_discount['price']),
                                'fob_price'         =>  sprintf ("%6.2f",$product_discount['fob_price']),
             ...
             for($i=0; $i<count($discount_steps)-1; $i++) {
                          ...
                          $data['product_discounts'][] = array(
                                ...
                                'quantity'          => $min,
                                'step_text'         => $min."+ ".$max,
                                'step_per_bottle'   => ($data['pf']*$min)."+ ".($data['pf']*$max),                  
                                'priority'          => '0',
                                'price'             =>  '',
                                'fob_price'         =>  '',
                                'bottle_price'        =>  '',
