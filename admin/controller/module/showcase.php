...
class ControllerModuleShowcase extends Controller {
	...
	public function index() {
		...
		$data['text_autowidth'] = $this->language->get('text_autowidth');
		...
		$data['entry_scrolltop'] = $this->language->get('entry_scrolltop');
	...
	public function install() {
		...
		$this->db->query("ALTER TABLE `" . DB_PREFIX . "manufacturer` ADD `sc_description` TEXT NULL default '' AFTER name;");
	...
	public function uninstall () {
		...
		$this->db->query("ALTER TABLE `" . DB_PREFIX . "manufacturer` DROP `sc_description`;");
	}
