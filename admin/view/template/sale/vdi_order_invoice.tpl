...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="subtotal cf">
            <h2><?php echo $text_subtotal; ?></h2>
            <span class="amount"><?php echo $subtotal; ?></span>
        </div><!-- subtotla -->
        ...
        <div class="payment-info cf">
            ...
            <ul class="right">
              ...
              <li>
                ...
                <span class="amount"><?php echo $shipping_cost; ?></span>
              </li>
              <?php } ?>
              <?php if ($coupon_amount) { ?>
              <li>
                <?php echo $coupon_title; ?>:
                <span class="amount"><?php echo $coupon_amount; ?></span>
              </li>
              <?php } ?>
              <?php if ($tax) { ?>
              <li>
                <?php echo $tax_title; ?>:
                <span class="amount"><?php echo $tax; ?></span>
              </li>
              <?php } ?>
              <li>
                <?php echo $text_total; ?>
