...
<div id="content" class="container">
  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><!--<a href="<?php echo $invoice; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_invoice_print; ?>" class="btn btn-info"><i class="fa fa-print"></i></a>-->  <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
      ...
      <ul class="breadcrumb">
        ...
        <script src="view/javascript/orderpopup.js"></script>
        ...
        <button id="help" class="btn btn-secondary" style='float:right;margin-right:10px;'>Aide</button>
    </div>
  </div>
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <span class="btn btn-warning margin-left-10" disabled><?php echo $order_status; ?></span>
      </div>
      <div class="order_id_big_monitor">
        <span class="order_id">Order #<?php echo $order_id?></span>
      </div>
      <div class="panel-body">
        <ul class="nav nav-tabs">
		  ...
		  <li><a href="#tab-product" data-toggle="tab"><?php echo $tab_product; ?><?php echo ($products_label ? '<span style="background-color:#DF2E1B;padding:4px 6px 4px 5px"  data-toggle="tooltip" title="'. $tooltip_products .'" class="label label-danger pull-right tab-label">'.$products_label.'</span>' : ''); ?></a></li>
		  <?php } ?>
          <?php if ($mvd_sales_order_history) { ?>
          <li>
              <a onclick="replace_icone();" href="#tab-history" data-toggle="tab">
                  <?php echo $tab_history;
                  if($order_status_id==19)
                  {
                    echo '<span data-toggle="tooltip" title="'. $tooltip_history .'" style="background-color:#DF2E1B;padding:4px 3px" class="label label-success pull-right tab-label"><i  >PO</i></span>';
                  }
                  elseif($order_status_id==3)
                  {
                   echo '<span style="padding :4px;!important;background-color:#DF2E1B" data-toggle="tooltip" title="'. $tooltip_truck .'" class="label label-success pull-right tab-label"><i  class="fa fa-truck"></i></span>';
                  }

                  elseif($order_status_id>3)
                  {
                    echo '<span style="padding :4px !important;" class="label label-success pull-right tab-label"><i  class="fa fa-check"></i></span>';
                  }
        ...
        <div class="tab-content">
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php echo $text_vintage; ?></td>
                  <td class="text-right"><?php echo $column_quantity; ?></td>
                  <td class="text-right"><?php echo $column_confirmed; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                    ...
                    <?php } ?>
                    <?php } ?></td>
                  <td class="text-left"><?php echo $product['vintage']; ?></td>
                  <td class="text-right"><?php echo $product['quantity']; ?></td>
                  <td class="text-right"><?php echo ($product['confirmed'] == 1 ? "<label class=\"label label-success\">".$text_confirmed_yes."</label>" : "<label class=\"label label-danger\">".$text_confirmed_no."</label>"); ?></td>
                  <td class="text-right"><?php echo $product['price']?></td>
                  <td class="text-right"><?php echo $product['total']; ?></td>
                  <td class="text-right"><button onclick="confirmProduct(this, <?php echo $product['pallet_product_id']; ?>);" class="btn btn-success" <?php echo (!$product['confirmed'] ?: "disabled"); ?>><i class="fa"></i> <?php echo $button_confirm; ?></button></td>
                </tr>
                <?php } ?>
                ...
                <?php } ?>
                <tr>
                  <td colspan="6" class="text-right"><?php echo $text_subtotal; ?>:</td>
                  <td class="text-right"><?php echo $subtotal; ?></td>
                  <td class="text-right"></td>
                </tr>
                <tr>
                  <td colspan="6" class="text-right"><?php echo $text_vat; ?>:</td>
                  <td class="text-right"><?php echo $vat; ?></td>
                  <td class="text-right"></td>
                </tr>
				<?php if ($shipping_weight) { ?>
				<tr>
                  <td colspan="6" class="text-right"><?php echo $shipping_weight; ?>:</td>
                  <td class="text-right"><?php echo $shipping_cost; ?></td>
                  <td class="text-right"></td>
                </tr>
				<?php } ?>
				<?php if ($coupon_amount) { ?>
				<tr>
                  <td colspan="6" class="text-right"><?php echo $coupon_title; ?>:</td>
                  <td class="text-right">-<?php echo $coupon_amount; ?></td>
                  <td class="text-right"></td>
                </tr>
				<?php } ?>
				<?php if ($tax) { ?>
				<tr>
                  <td colspan="6" class="text-right"><?php echo $tax_title; ?>:</td>
                  <td class="text-right"><?php echo $tax; ?></td>
                  <td class="text-right"></td>
                </tr>
				<?php } ?>
				<tr>
                  <td colspan="6" class="text-right"><?php echo $text_total; ?>:</td>
                  <td class="text-right"><?php echo $totals; ?></td>
                  <td class="text-right"></td>
                </tr>
              </tbody>
            </table>
            <?php if(!$button_disabled and $order_status_id==$status_waiting_po_confirmation) { ?>
              <div class="alert alert-success text-center col-xs-offset-3 col-xs-6"><?php echo $text_products_confirmed; ?></div>
            <?php } elseif ($button_disabled and $order_status_id==$status_waiting_po_confirmation) { ?>
              <div class="alert alert-warning text-center col-xs-offset-3 col-xs-6"><?php echo $text_products_need_confirmation; ?></div>
            <?php } ?>
          </div>
		  <?php } ?>
		  <?php if ($mvd_sales_order_history) { ?>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="well well-order-status"><?php echo $order_statuses_by_id[$order_status_id]['name'];?></div>
          ...
          <input type="hidden" name="order_status_id" value="<?php echo $order_status_id;?>">
                ...
                <!--<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="notify" value="1" id="input-notify" />
                  </div>
                </div>
                <div class="form-group">
              ...
              <input type="hidden" name="comment" value="" id="input-comment" />

                  <?php if ($button_disabled and $order_status_id==$status_waiting_po_confirmation) { ?>
                    <div class="alert alert-warning text-center col-xs-offset-3 col-xs-6"><?php echo $text_history_need_confirmation; ?></div>
                  <?php } else if(!$button_disabled and $order_status_id==$status_waiting_po_confirmation) { ?>
                    <div class="alert alert-warning text-center col-xs-offset-3 col-xs-6"><?php echo $text_history_ready_to_confirm; ?></div>
                  <?php } ?>

                  <?php if (!$button_disabled and $order_status_id==$status_po_confirmed) { ?>
                    <div class="row alert alert-success col-sm-offset-2 col-sm-10">
                      <div class="col-sm-8">
                        <p><?php echo $text_history_tracking_information; ?></p>
                      </div>
                      <div class="col-sm-4">
                        <select id="po_transporter" name="transporter" class="form-control">
                          <option value=""> - Choose shipping - </option>
                          <?php foreach($transporters as $transporter) {?>
                            <option value="<?php echo $transporter['name']; ?>"><?php echo $transporter['name']; ?></option>
                          <?php } ?>
                          <option value="shipping_by_myself"><?php echo $shipping_by_myself; ?></option>
                        </select>
                        <div id="po_ref_number" style="display:none;"><br>
                        <input name="ref_number" value="" placeholder="<?php echo $text_field_ref_number; ?>" id="input-quantity" class="form-control" type="text"></div>
                        <div id="po_error" style="display:none;"><br><div id="po_error_text" class="text-danger"></div></div>
                      </div>
                    </div>
                  <?php } ?>
                  </form>
                  ...
                  <div class="text-right">
                    <?php if(isset($button_action) and !$button_disabled) { ?>
                      <button id="button-history" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa"></i> <?php echo $button_action; ?></button>
                    <?php } else { ?>
                      <?php if(isset($text_noactions)) { ?>

                        <div class="alert alert-warning text-center col-xs-offset-3 col-xs-6"><?php echo $text_noactions; ?>
                            <?php if($order_status_id!=3) { ?>
                            <div id="checked_div" style="margin-top:15px;background: transparent url(&quot;/admin/view/image/spiffygif_30x30.gif&quot;) no-repeat scroll center center; float: left; width: 100%; height: 46px;">
                            </div>
                            <?php } ?>
                        </div>
                        <?php if($order_status_id!=3) { ?>
                    ...
                    <div class="text-right">
                        <div style="padding:0" class="text-center col-xs-offset-3 col-xs-6">
                            <a style="width:100%;padding:12px 32px;  font-size:large; text-transform: uppercase;" href="<?php echo $shipping_pdf; ?>" target="_blank" class="btn btn-danger">
                                <i class="fa fa-print"></i>&nbsp;&nbsp;&nbsp; <?php echo $button_packing_list_print; ?></span>
                            </a>
                        </div>
                      <?php } ?>
                      <?php } ?>
          ...
          <div class="order_total_big_monitor">
            <span>Total Commande: <?php echo $total; ?></span>
          </div>
        </div>
      </div>
    </div>
...
$(document).ready(function() {
  if(getUrlParameter('tab')) {
    ...
    $('.nav-tabs li:nth-child('+ tab +') a').trigger('click');
  }
});

$(document).ready(function() {
  $('#po_transporter').change(function() {
    var value = $("#po_transporter option:selected").val().trim();
    var hideon = ['', 'shipping_by_myself'];
    if($.inArray(value, hideon) != -1) {
      $("#po_ref_number").hide();
    } else {
      $("#po_ref_number").show();
    }
...
$(document).delegate('.vendor-confirm', 'click', function() {
  $.ajax({
    url: 'index.php?route=sale/vdi_order/info&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&tab=1',
    dataType: 'json',
...
function confirmProduct(btn, product_id) {
  $(btn).find('i').toggleClass('fa-spinner fa-spin');

  $.ajax({
    url: 'index.php?route=sale/vdi_order/confirmProduct&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&product_id=' + product_id,
    dataType: 'json',
    success: function(json) {
      $('.alert').remove();

      if (json['error']) {
        $('#tab-product').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '</div>');
      }
      setTimeout(function () {
        location.href = 'index.php?route=sale/vdi_order/info&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&tab=2';
      }, 1000);
    },
    error: function(xhr, ajaxOptions, thrownError) {
      alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/vdi_order/createinvoiceno&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/vdi_order/addreward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/vdi_order/removereward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/vdi_order/addcommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/vdi_order/removecommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$('#history').load('index.php?route=sale/vdi_order/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');

$('#button-history').on('click', function() {

  if($("#po_transporter option:selected").val() == "") {
    $("#po_error_text").text("Please select Transporter");
    $("#po_error").show();
    return false;
  } else if($("#po_transporter option:selected").val() == "shipping_by_myself") {
  } else if($("#po_transporter option:selected").val() != "" && $("#po_ref_number input").val() == "") {
    $("#po_error_text").text("Please enter Ref Number");
    $("#po_error").show();
    return false;
  }
  ...
  $('#button-history').find('i').toggleClass('fa-spinner fa-spin');

	$.ajax({
		url: 'index.php?route=sale/vdi_order/api&token=<?php echo $token; ?>&api=api/vdi_order/history&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('input[name=\'order_status_id\']').val()) + '&vendor_id=' + <?php echo $vendor_id;?> + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()) + '&transporter=' + encodeURIComponent($('select[name=\'transporter\']').val()) + '&ref_number=' + encodeURIComponent($('input[name=\'ref_number\']').val()),
		success: function(json) {
			$('.alert').remove();
        ...
        setTimeout(function () {
          location.href = 'index.php?route=sale/vdi_order/info&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&tab=3';
        }, 1000);
			}
		},
		error: function(xhr, ajaxOptions, thrownError) {
...
function replace_icone(){
setTimeout("rep()",5000);

}
function rep(){
$("#checked_div").css("background",'transparent url("/admin/view/image/onebit_34.png") no-repeat scroll center center');
}
$(document).ready(function() {
  changeStatus();
  setTimeout("rep()",5000);
