...
<h4 style="color:#333"><b><?php echo $text_shipmentid.": ".$order['shipment_id']; ?></b></h4>
	  ...
	  <td  width="50%" align="right">
      		...
      		<div style="border:5px #000 solid; width:40pt; height:40pt; float:right">
            	<center><h1 style="color:#000"><b>A</b></h1></center>
      		</div>
      </td>
    </tr>
  </table>
    ...
    <table class="table table-bordered">
      <thead style="display:table-header-group;">
        <tr>
          ...
          <td class="text-center"><b><?php echo $column_weight; ?></b></td>
          <td class="text-center"><b><?php echo $column_total; ?></b></td>
          <td class="text-center"><b><?php echo $text_order_total; ?></b></td>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right"><?php echo $product['hkd_order_total']; ?><br><?php echo $product['eur_order_total']; ?></td>
        </tr>
        <?php } ?>
        <tr>
            <td class="text-right" colspan="5"><b><?php echo $text_super_total; ?></b></td>
            <td class="text-right"><b><?php echo $order['total_quantity']; ?></b></td>
            <td class="text-right"><b><?php echo $order['bottle_grand_total']; ?></b></td>
            <td class="text-right"><b><?php echo $order['weight_grand_total']; ?></b></td>
            <td class="text-right"><b><?php echo $order['hkd_grand_total']."<br>".$order['eur_grand_total']; ?></b></td>
            <td class="text-right"><b><?php echo $order['hkd_grand_order_total']."<br>".$order['eur_grand_order_total']; ?></b></td>
        </tr>
        <tr>
            <td class="text-right" ><b><?php echo $text_total_pallet; ?></b></td>
            <td class="text-right"><b><?php echo $order['total_pallet']; ?></b></td>
        </tr>
        <tr>
            <td class="text-right" ><b><?php echo $text_total_volume; ?></b></td>
            <td class="text-right"><b><?php echo $order['total_volume']; ?></b></td>
        </tr>
      </tbody>
    </table>
  </div>
