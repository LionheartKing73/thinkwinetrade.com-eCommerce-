    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
		  ...
		  <li><a href="#tab-product" data-toggle="tab"><?php echo $tab_product; ?><?php echo ($products_label ? '<span data-toggle="tooltip" title="'. $tooltip_products .'" class="label label-danger pull-right tab-label">'.$products_label.'</span>' : ''); ?></a></li>
		  <?php } ?>
          <?php if ($mvd_sales_order_history) { ?>
		  <li><a href="#tab-history" data-toggle="tab"><?php echo $tab_history; ?><?php echo ($history_label ? '<span data-toggle="tooltip" title="'. $tooltip_history .'" class="label label-success pull-right tab-label"><i class="fa fa-exclamation"></i></span>' : ''); ?></a></li>
		  <?php } ?>
          <?php if ($maxmind_id) { ?>
                ...
                <div class="row alert alert-success col-sm-offset-2 col-sm-10">
                  ...
                  <div class="col-sm-4">
                    <select id="po_transporter" name="transporter" class="form-control">
                      <option value=""><?php echo $text_choose_shipping; ?></option>
              ...
              <div class="text-right">
                ...
                <?php } else { ?>
                  <?php if(isset($text_noactions)) { ?>
                    <div class="alert alert-warning text-center col-xs-offset-3 col-xs-6"><?php echo $text_noactions; ?></div>
                  <?php } ?>
                <?php }  ?>
              </div>
