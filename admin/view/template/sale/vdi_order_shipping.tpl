...
<div class="container">
  ...
  <div style="page-break-after: always;">
    <div  class="table-bordered5a" style="max-width: 98%; padding:1%">
        <h1><?php echo strtoupper($text_picklist); ?> #<?php echo $order['order_id']; ?>&nbsp;&nbsp;Vendor ID: <?php echo $vendor_id; ?> <img src="view/stylesheet/invoice-assets/logo_new.png" alt="thinkwinetrade" style="float:right;"  /></h1>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <?php echo $wh_email; ?><br/>
            <?php echo $wh_telephone; ?><br/>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right"><b><?php echo $total_quantity; ?></b></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table table-bordered">
      <thead>
      	...
      	<tr>
        	<td><b><?php echo $text_nof_pallet; ?></b> <?php echo $total_pallet; ?></td>
            <td><b><?php echo $text_nof_prod; ?></b> <?php echo $total_product; ?></td>
        </tr>
	  </thead>
    </table>
    <hr class="table-bordered5a"  style=" max-width:98%; border-bottom-width:0px; border-left-width:0px; border-right-width:0px" />
    ...
    <br/>
    <div  class="table-bordered5a" style="width: 98%; "min-height:150px; ">
    	<p style=" padding:1%"><?php echo $admin_comment; ?></p>
    </div>
	<?php } ?>
  </div>
  <?php } ?>
