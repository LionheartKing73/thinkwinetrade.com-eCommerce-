                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $column_variations; ?></td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $page['title']; ?></td>
                                    <td class="text-left"><?php echo $page['variations']; ?></td>
                                    <td class="text-right"><?php echo $page['sort_order']; ?></td>
                                    <td class="text-right">
                                        <a href="<?php echo $page['view']; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                ...
                                <?php } else { ?>
                                <tr>
                                    <td class="text-center" colspan="5"><a href="<?php echo $add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $button_create_page; ?></a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
