<div class="block-inner block-tour block-container col-sm-<?php echo $size; ?> level<?php echo $level; ?>" id="<?php echo $key; ?>" data-id="<?php echo $key; ?>" data-title="<?php echo $title; ?>"
    ...
    <div class="block-content tour-content clearfix <?php echo isset($child)?'child':'';?>" data-id="<?php echo $key; ?>">
        ...
        <ul class="vd-tour-list">
            <?php foreach ($setting['setting_child'] as $child_id => $value) { ?>
                <li class="vd-tab" data-toogle-id="<?php echo $value['section_id'] ?>" data-control="<?php echo $child_id; ?>">
                  <a class="drag"><span class="vd-tab-title"><?php echo $value['title']; ?></span></a>
    ...
    <script type="text/javascript">
           ...
           $(document).on('click', '#<?php echo $key; ?> > .block-content > .vd-tour-list > .vd-tab > a.drag:not(#button_add_child)', function(){
        ...
        $('#<?php echo $key; ?> > .block-content > .vd-tour-list > .vd-tab:eq(<?php echo $setting["active_section"] ?>) > a.drag:not(#button_add_child)').trigger("click");
    </script>
</div>
