    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-5">
          ...
          <button type="button" data-toggle="tooltip" title="<?php echo $button_upload; ?>" id="button-upload" class="btn btn-primary"><i class="fa fa-upload"></i> Télécharger</button>
        </div>
        <div class="col-sm-7">
...
$('#button-search').on('click', function() {
	var url = 'index.php?route=common/vdi_filemanager&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-upload').on('click', function() {
	...
	$('#form-upload input[name=\'file\']').on('change', function() {
		$.ajax({
			url: 'index.php?route=common/vdi_filemanager/upload&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',		
			dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: 'index.php?route=common/vdi_filemanager/folder&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',		
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: 'index.php?route=common/vdi_filemanager/delete&token=<?php echo $token; ?>',
			type: 'post',		
			dataType: 'json',
