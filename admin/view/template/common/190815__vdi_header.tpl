  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li><a href="#" onclick="return false;"><span class="label label-danger pull-right"><?php echo $po_confirm_total; ?></span><?php echo $text_po_confirm; ?></a></li>
        </li>
        <li class="divider"></li>
        ...
        <li><a href="<?php echo $product_pending_approval; ?>"><span class="label label-danger pull-right"><?php echo $product_pending_approval_total; ?></span><?php echo $text_approval; ?></a></li>
        <li><a href="#" onclick="return false;"><span class="label label-danger pull-right"><?php echo $products_confirm_total; ?></span><?php echo $text_products_confirm; ?></a>
       </ul>
    </li>
