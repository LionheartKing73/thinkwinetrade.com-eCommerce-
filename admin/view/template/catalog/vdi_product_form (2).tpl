    ...
    <div class="page-header">
      <div class="container-fluid">
        <div class="pull-right">
          <button type="submit" form="form-product" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
              ...
              <div class="tab-pane" id="tab-data">
                ...
                <div class="table-responsive">
                  <table id="discount" class="table table-striped table-bordered table-hover">
                    <caption><strong><?php echo $entry_discount_head; ?></strong></caption>
                    <thead>
                     <tr>
                      <!--
                        <td class="text-left"><?php echo $entry_customer_group; ?></td>
                     -->
                        <td class="text-right" style="width: 20%;"><?php echo $entry_quantity; ?></td>
                        <td class="text-right" style="width: 20%;"><?php echo $entry_price; ?></td>
                        <td class="text-right" style="width: 15%;"><?php echo $twt_bottle_price; ?></td>
                        <td class="text-right" style="width: 15%;"><?php echo $twt_cartoon_price; ?></td>
                    ...
                    <tbody>
                      ...
                      <!--
                        ...
                        <td class="text-right">
                             ...
                             <?php echo $product_discount['step_text']; ?><br />steps
                             <em style="font-size:12px"><?php echo $product_discount['step_per_bottle']; ?></em>
                        </td>
                        <?php
                             $class = "";
                        ...
                        <td class="text-right<?php echo $class; ?>">
                               <input type="text" name="product_discount[<?php echo $discount_row; ?>][fob_price]" value="<?php echo $product_discount['fob_price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" />
                        </td>
                        <td class="text-right">
                ...
                <div class="table-responsive">
                  <table id="special" class="table table-striped table-bordered table-hover">
                    <caption><strong>Promotion sur Produit</strong></caption>
                    <thead>
                      <tr>
                     <!--   <td class="text-left"><?php echo $entry_customer_group; ?></td>-
...
function addSpecial() {
	if (special_row >0) return; //zighia
...
function getMeta(val) {
 ...
 $("input[id^='keyword']").each(function(index, element) {
            id = $(this).attr('id').replace('input-name','');
           if(id != val){
               $(this).val(product_name);
            }
