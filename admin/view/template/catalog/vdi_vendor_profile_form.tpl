              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab-general">
        		  ...
        		  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
        			  <textarea name="vendor_description" id="vendor_description" rows="5" placeholder="<?php echo $entry_description; ?>" class="form-control"><?php echo $vendor_description; ?></textarea>
                    </div>
                  </div>
        		  <div class="form-group">
                  ...
                  <div class="form-group <?php echo ($step3==1)? 'aware' : '';?>">
                    <label class="col-sm-2 control-label" for="input-payment_info"><?php echo $entry_payment_info; ?></label>
                    <div class="col-sm-10">
                    <input type="text" name="payment" value="<?php echo $payment; ?>" placeholder="<?php echo $entry_payment_info; ?>" id="input-payment_info" class="form-control " />
        			</div>
                  </div>
        		  <div class="form-group <?php echo ($step1==1)? 'aware' : '';?>">
                ...
                <div class="tab-pane" id="tab-finance">
                 <input type="hidden" name="paypal_email" value="" class="form-control" />
                <!--
                  <div class="form-group required">
...
//--></script>
<script type="text/javascript"><!--
$('#vendor_description').summernote({height: 300});
//--></script>
<script type="text/javascript">
<?php echo $footer; ?>
