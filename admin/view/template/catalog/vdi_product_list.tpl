                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right"><a href="<?php echo $product['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary status_enabled"><i class="fa fa-pencil"></i>&nbsp;<?php echo $button_edit_product; ?></a></td>
                    </tr>
                    <tr>
