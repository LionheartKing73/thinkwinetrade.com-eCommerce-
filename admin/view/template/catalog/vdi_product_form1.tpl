         ...
         <ul class="nav nav-tabs" role="tablist">
             <?php
                ...
                if (count($product_specials))
                       $class_active ="";
             ?>
             <li role="presentation"<?=$class_active?>><a href="#discount_price" aria-controls="discount_price" role="tab" data-toggle="tab" id="li_discount_price">
                   <?php
             ...
             <?php
                ...
                if (count($product_specials))
                       $class_active = 'class="active"';
             ?>
             <li role="presentation"<?php echo count($product_specials)?'class="active"':""?>><a href="#special_price" aria-controls="special_price" role="tab" data-toggle="tab" id="li_special_price">
                    ...
                    ?>
                      ...
                      <!--
                        ...
                        <td class="text-right">
                             ...
                             <?php echo $product_discount['step_text']; ?><br />
