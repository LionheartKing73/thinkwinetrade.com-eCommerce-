      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-general">
		  ...
		  <div class="form-group required">
            ...
            <div class="col-sm-10">
			  <textarea name="vendor_description" id="vendor_description" rows="5" placeholder="<?php echo $entry_description; ?>" class="form-control d_visual_designer"><?php echo $vendor_description; ?></textarea>
            </div>
          </div>
		  <div class="form-group">
...
<script src="view/javascript/d_visual_designer/d_visual_designer.js?1.1.0" type="text/javascript"></script>
