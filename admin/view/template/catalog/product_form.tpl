    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
             ...
             <div class="form-group required">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-weight">Fake price</label>
                <div class="col-sm-10">
                  <input type="number" step="0.1" min="0" max="100" name="fakeprise" value="<?php echo $fakeprise; ?>" id="input-weight" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                    ...
                    <tr id="special-row<?php echo $special_row; ?>">
                      ...
                      <td class="text-left" style="width: 20%;"><div class="input-group date">
                          <input type="text" name="product_special[<?php echo $special_row; ?>][date_end]" value="<?php echo $product_special['date_end']; ?>" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" />
                           <input type="hidden"  name="product_special[<?php echo $special_row; ?>][fob_price]" value="<?php echo $product_special['fob_price']; ?>" />
                            <input type="hidden" name="product_special[<?php echo $special_row; ?>][sp_price]" value="<?php echo $product_special['sp_price']; ?>" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
		  ...
		  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-column">Custom CSS</label>
                <div class="col-sm-10">
                  <textarea  name="custom_css"   placeholder="Custom css for breadcrumbs"  id="custom_css" class="form-control" ><?php echo $custom_css; ?></textarea>
                </div>
              </div>
