     ...
     <div class="form-group">
         <ul class="nav nav-tabs" role="tablist">
             ...
             <li role="presentation"<?=$class_active?> >
                 <a href="#discount_price" aria-controls="discount_price" role="tab" zdata-toggle="tab" data-toggle="collapse" id="li_discount_price">
                   <?php
         ...
         <?php
                ...
                if (count($product_specials) && ($error_discount_price == ""))
                       $class_active ="";
         ?>
                <div zrole="tabpanel" aria-expanded="true" zclass="tab-pane<?=$class_active?>" id="discount_price" class="collapse in">
                <?php
