        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-minimum">Fake price</label>
                <div class="col-sm-10">
                  <input type="number" step="0.1" min="0" max="100" name="fakeprise" value="<?php echo $fakeprise; ?>" id="input-fakeprise" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="special-row<?php echo $special_row; ?>">
                      ...
                      <button type="button" onclick="$('#special-row<?php echo $special_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $special_row++; ?>
                    <?php } ?>
                  </tbody>
