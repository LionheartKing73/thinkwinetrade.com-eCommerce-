  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-rating').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-vendor"><?php echo $entry_vendor; ?></label>
                <input type="text" name="filter_vendor" value="<?php echo $filter_vendor; ?>" placeholder="<?php echo $entry_vendor; ?>" id="input-vendor" class="form-control" />
              </div>
              <div class="form-group">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($rating['rating_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $rating['order_id']; ?></td>
				  <td class="text-left"><?php echo $rating['name']; ?></td>
                  <td class="text-left"><?php echo $rating['author']; ?></td>
                  <td class="text-right"><?php if($rating['rating'] ==1){echo $text_yes;}else{echo $text_no;} ?></td>
                  <td class="text-left"><?php echo $rating['status']; ?></td>
                  <td class="text-left"><?php echo $rating['date_added']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=catalog/rating&token=<?php echo $token; ?>';
