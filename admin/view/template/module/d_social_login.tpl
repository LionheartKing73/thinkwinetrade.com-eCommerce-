                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="setting_provider" class="tab-pane">
                            ...
                            <?php foreach($providers as $key => $provider) { ?>
                            <div class="form-group">
                                <h4 class="col-sm-12" for="select_return_url"><i class="<?php echo $provider['icon']; ?>"></i> <?php echo $provider['id']. ' '.$text_app_settings ?><input type="hidden" name="<?php echo $id;?>_setting[providers][<?php echo $key; ?>][id]" value="<?php echo $provider['id']; ?>" /></h4>
                                <div class="col-sm-12">
                        ...
                        <div class="tab-pane" id="instruction" >
                            <div class="tab-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="wrap-5">
                                            <h1><?php echo $text_instruction ?></h1>
