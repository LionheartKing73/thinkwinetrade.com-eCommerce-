...
if(empty($aslider_height)) $aslider_height = 500;
					...
					<div class="form-group">
						...
						<div class="col-sm-10 ">
							<select name="aslider_store_id" id="aslider_store_id" class="form-control input">
								...
								<option value="<?php echo HTTPS_SERVER . 'index.php?route=module/megaslider&store_id=' . $store['store_id'] . '&token=' . $session->data['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>					
					...
					<div class="tab-content tab_slides">
						...
						<div id="tab_slider_<?php echo $i; ?>" class="tab-pane">
							...
							<ul id="tabs_slider_<?php echo $i; ?>_language" class="nav nav-tabs">
								...
								<li><a href="#tab_slider_<?php echo $i; ?>_language_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>
								<?php } ?>
							</ul>
