              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                    <?php foreach ($languages as $language) { ?>
                      <select name="showcase[<?php echo $language['language_id']; ?>][tag]" class="form-control">
                        <?php if (isset($showcase[$language['language_id']]['tag']) && $showcase[$language['language_id']]['tag'] == 'h3') { ?>
                        <option value="h3" selected="selected">h3</option>
                        <?php } else { ?>
                        <option value="h3">h3</option>
                        <?php } ?>
                        <?php if (isset($showcase[$language['language_id']]['tag']) && $showcase[$language['language_id']]['tag'] == 'h4') { ?>
                        <option value="h4" selected="selected">h4</option>
                        <?php } else { ?>
                        <option value="h4">h4</option>
                        <?php } ?>
                        <?php if (isset($showcase[$language['language_id']]['tag']) && $showcase[$language['language_id']]['tag'] == 'h5') { ?>
                        <option value="h5" selected="selected">h5</option>
                        <?php } else { ?>
                        <option value="h5">h5</option>
                        <?php } ?>
                        <?php if (isset($showcase[$language['language_id']]['tag']) && $showcase[$language['language_id']]['tag'] == 'h6') { ?>
                        <option value="h6" selected="selected">h6</option>
                        <?php } else { ?>
                        <option value="h6">h6</option>
                        <?php } ?>
                        <?php if (isset($showcase[$language['language_id']]['tag']) && $showcase[$language['language_id']]['tag']== 'div') { ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <div class="radio">
                        <label>
                          <input type="radio" name="showcase[type]" value="parent" <?php echo isset($showcase['type']) && $showcase['type'] == 'parent' ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#categories').show();$('#brands,#tree-categories').hide();}" />
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="items">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8 col-sm-offset-4" style="margin-top: 15px;">
                          <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="col-sm-8 col-sm-offset-4">
                          <div class="checkbox" style="margin-top: 15px; margin-bottom: 0;">
                            <label>
                              <input type="checkbox" name="showcase[autowidth]" value="1" <?php echo isset($showcase['autowidth']) ? 'checked="checked"' : ''; ?> />
                              <?php echo $text_autowidth; ?> </label>
                          </div>
                        </div>
                      </div>
                      <hr />
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="showcase[item_margin]" value="<?php echo isset($showcase['item_margin']) ? $showcase['item_margin'] : '20'; ?>" class="form-control text-center" />
                        </div>
                      </div>
                      <hr />
                      <div class="form-group">
                        <label class="col-sm-4 control-label"><?php echo $entry_scrolltop; ?></label>
                        <div class="col-sm-4">
                          <select name="showcase[scrolltop]" class="form-control">
                            <?php if (!empty($showcase['scrolltop'])) { ?>
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="showcase[scrolltop_speed]" value="<?php echo !empty($showcase['scrolltop_speed']) ? $showcase['scrolltop_speed'] : '300'; ?>" class="form-control text-center" />
                        </div>
                      </div>
                      <hr />
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <select name="showcase[item_image]" class="form-control">
                            <?php if ($showcase['item_image']) { ?>
                            <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                            <option value="0"><?php echo $text_disabled; ?></option>
                            <?php } else { ?>
                            <option value="1"><?php echo $text_enabled; ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <div class="btn-group btn-group-justified" data-toggle="buttons">
                            <label class="btn btn-success">
                              <input type="radio" name="showcase[items_carousel]" value="1" onchange="if($(this).prop('checked')) {$('#itemcarousel-config').show();}" <?php echo isset($showcase['items_carousel']) ? 'checked="checked"' : ''; ?> />
                              <?php echo $text_enabled; ?> </label>
                              <label class="btn btn-danger">
                                <input type="radio" name="showcase[items_carousel]" value="0" onchange="if($(this).prop('checked')) {$('#itemcarousel-config').hide();}" <?php echo empty($showcase['items_carousel']) ? 'checked="checked"' : ''; ?> />
                                <?php echo $text_disabled; ?> </label>
                          </div>
                        </div>
                      </div>
                      <div id="itemcarousel-config" <?php echo !empty($showcase['items_carousel']) ? '' : 'style="display:none;"' ; ?>>
                        <hr />
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <div class="checkbox">
                              <label>
                                <input type="checkbox" name="showcase[autoplay]" value="1" <?php echo isset($showcase['autoplay']) ? 'checked="checked"' : ''; ?> />
                                <?php echo $text_autoplay; ?> </label>
                            </div>
                          </div>
                          <div class="col-sm-2">
                            <input type="text" name="showcase[autoplay_speed]" value="<?php echo !empty($showcase['autoplay_speed']) ? $showcase['autoplay_speed'] : '500'; ?>" class="form-control text-center" />
                          </div>
                          <div class="col-sm-2">
                            <input type="text" name="showcase[autoplay_timeout]" value="<?php echo !empty($showcase['autoplay_timeout']) ? $showcase['autoplay_timeout'] : '5000'; ?>" class="form-control text-center" />
                          </div>
                        </div>
                        <hr />
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="showcase[items_nav_speed]" value="<?php echo !empty($showcase['items_nav_speed']) ? $showcase['items_nav_speed'] : '250'; ?>" class="form-control text-center" />
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div id="outside" <?php echo empty($showcase['subitems_pos']) || $showcase['subitems_pos'] == 'outside' ? '' : 'style="display:none;"'; ?>>
                        <div class="form-group">
                          ...
                          <div class="col-sm-8 col-sm-offset-4">
                            <div class="checkbox" style="margin-top: 15px; margin-bottom: 0;">
                              <label>
                                <input type="checkbox" name="showcase[subautowidth]" value="1" <?php echo isset($showcase['subautowidth']) ? 'checked="checked"' : ''; ?> />
                                <?php echo $text_autowidth; ?> </label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-sm-4 control-label"><?php echo $entry_margin; ?></label>
                          <div class="col-sm-4">
                            <input type="text" name="showcase[subitem_margin]" value="<?php echo isset($showcase['subitem_margin']) ? $showcase['subitem_margin'] : '20'; ?>" class="form-control text-center" />
                          </div>
                        </div>
                        <hr />
                        <div class="form-group">
                          <label class="col-sm-4 control-label"><?php echo $entry_image; ?></label>
                          <div class="col-sm-4">
                            <select name="showcase[subitem_image]" class="form-control">
                              <?php if ($showcase['subitem_image']) { ?>
                              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                              <option value="0"><?php echo $text_disabled; ?></option>
                              <?php } else { ?>
                              <option value="1"><?php echo $text_enabled; ?></option>
                        ...
                        <hr />
                        <div class="form-group">
                          <label class="col-sm-4 control-label"><?php echo $entry_parent_desc; ?></label>
                          <div class="col-sm-4">
                            <select name="showcase[description_status]" class="form-control">
                              <?php if (!empty($showcase['description_status'])) { ?>
                              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                              <option value="0"><?php echo $text_disabled; ?></option>
                              <?php } else { ?>
                              <option value="1"><?php echo $text_enabled; ?></option>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="btn-group btn-group-justified" data-toggle="buttons">
                              <label class="btn btn-success">
                                <input type="radio" name="showcase[subitems_carousel]" value="1" <?php echo isset($showcase['subitems_carousel']) ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#subitemcarousel-config').show();}" />
                                <?php echo $text_enabled; ?> </label>
                              <label class="btn btn-danger">
                                <input type="radio" name="showcase[subitems_carousel]" value="0" <?php echo empty($showcase['subitems_carousel']) ? 'checked="checked"' : ''; ?> onchange="if($(this).prop('checked')) {$('#subitemcarousel-config').hide();}" />
                                <?php echo $text_disabled; ?> </label>
                            </div>
                          </div>
                        </div>
                        <div id="subitemcarousel-config" <?php echo !empty($showcase['subitems_carousel']) ? '' : 'style="display:none;"' ; ?>>
                          <hr />
                          <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-4">
                              <div class="checkbox">
                          ...
                          <div class="form-group">
                            <label class="col-sm-4 control-label"><?php echo $entry_nav_speed; ?></label>
                            <div class="col-sm-4">
                              <input type="text" name="showcase[subitems_nav_speed]" value="<?php echo !empty($showcase['subitems_nav_speed']) ? $showcase['subitems_nav_speed'] : '250'; ?>" class="form-control text-center" />
                            </div>
                          </div>
                        </div>
                      </div>
