...
//imformation vendor
    ...
    public function check() {
		...
		if (isset($user_info['user_group_id']) && $user_info['user_group_id'] == 50) {
			$this->load->model('localisation/language');
            $langs = $this->model_localisation_language->getLanguages();
			
			if ($this->session->data['admin_language_id'] != $langs['fr']['language_id']) {
				$this->session->data['admin_language_id'] = $langs['fr']['language_id'];
