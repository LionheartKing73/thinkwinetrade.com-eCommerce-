...
class ControllerCatalogAttribute extends Controller {
	...
	protected function getForm() {
        ...
        $data['entry_attribute_type'] = $this->language->get('entry_attribute_type');
        $data['entry_attribute_values'] = $this->language->get('entry_attribute_values');
        $data['entry_attribute_ranges'] = $this->language->get('entry_attribute_ranges');
		...
		if (isset($this->request->post['attribute_group_id'])) {
			...
			$data['attribute_group_id'] = '';
                ...
                $data['attribute_types'] = $this->model_catalog_attribute->getAttributeTypes();

                if (isset($this->request->post['attribute_values'])) {
                    $data['attribute_values'] = $this->request->post['attribute_values'];
                } elseif (isset($this->request->get['attribute_id'])) {
                    $data['attribute_values'] = $this->model_catalog_attribute->getAttributeValues($this->request->get['attribute_id']);
                } else {
                    $data['attribute_values'] = array();
                }
                
                if (isset($this->request->post['attribute_type'])) {
                    $data['attribute_type_id'] = $this->request->post['attribute_type'];
                } elseif (!empty($attribute_info)) {
                    $data['attribute_type_id'] = $attribute_info['attribute_type'];
                } else {
                    $data['attribute_type_id'] = '';
                }

                if (isset($this->request->post['attribute_range'])) {
                    $data['attribute_range'] = $this->request->post['attribute_range'];
                } elseif (isset($this->request->get['attribute_id'])) {
                    $data['attribute_range'] = $this->model_catalog_attribute->getAttributeRanges($this->request->get['attribute_id']);
                } else {
                    $data['attribute_range'] = array();
                }
