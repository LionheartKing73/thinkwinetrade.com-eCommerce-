...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_name'] = $this->language->get('entry_name');
            ...
            $data['entry_scdescription'] = $this->language->get('entry_scdescription');
		...
		if (isset($this->request->post['image'])) {
            ...
            if (isset($this->request->post['sc_description'])) {
                $data['sc_description'] = $this->request->post['sc_description'];
            } elseif (!empty($manufacturer_info)) {
                $data['sc_description'] = $manufacturer_info['sc_description'];
            } else {
                $data['sc_description'] = '';
            }
