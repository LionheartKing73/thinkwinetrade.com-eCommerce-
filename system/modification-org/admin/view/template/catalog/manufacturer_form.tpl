            ...
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <?php } ?>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-sc-description"><?php echo $entry_scdescription; ?></label>
                    <div class="col-sm-10">
                      <textarea name="sc_description" rows="5" placeholder="<?php echo $entry_scdescription; ?>" id="input-sc-description" class="form-control"><?php echo $sc_description; ?></textarea>
                    </div>
                  </div>
