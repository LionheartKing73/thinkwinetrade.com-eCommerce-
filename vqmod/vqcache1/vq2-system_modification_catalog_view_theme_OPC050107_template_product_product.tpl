...
<p class="selspan"><img class="navbar-profile-avatar img-circle" style="margin: 0px 5px; border: 1px solid rgb(204, 204, 204);" src="<?php echo $image_vendor; ?>"> <b><img src="../image/flags/<?php echo $vendor_country; ?>.png" width="10px" height="10px"> <?php echo $vendor; ?></b>  <span color:#EC1F6B;><img style="margin-left:-4px;" class="selimgx" src="image/thropy.png" width="5%" data-toggle="tooltip" data-html="true" data-original-title="<?php echo $text_vendor_rating_tooltip; ?>"><?php echo $vendor_rating;?></span> <?php if(isset($vendor_in_pallet)) { ?><br><span class="this-vendor-in-pallet"><label class="label <?php echo ($vendor_in_pallet['vendorLimitNotMet'] ? "label-danger" : "label-success"); ?>"><?php echo $vendor_in_pallet['qty']; ?></label></span><?php } ?></p>
            ...
            <div class="form-group quntity">
                            ...
                            <div class="button-group pro-button">
                                <button type="button"  title="<?php echo $button_cart; ?>" data-toggle="tooltip" class="addtocart greenBtn" onclick="worksheet.addtopallet(this, '<?php echo $product_id; ?>');"><img src="./image/demo-img/pallet.png" class="pallet-icon"> <span><?php echo $button_cart; ?></span></button>
