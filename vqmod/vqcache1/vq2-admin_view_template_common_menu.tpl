<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
	  ...
	  <li><a href="<?php echo $rating; ?>"><?php echo $text_rating; ?></a></li>
...
<li><a href="<?php echo $newssubscribe; ?>"><?php echo $text_newssubscribe; ?></a></li>
      ...
      <li><a href="<?php echo $wine_rating; ?>">Wine ratings</a></li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <li><a class="parent"><?php echo $text_paypal ?></a>
        ...
        <li><a href="<?php echo $mvd_vendor_carriers; ?>"><?php echo $text_vendor_carriers; ?></a></li>
			  </ul>
			</li>
