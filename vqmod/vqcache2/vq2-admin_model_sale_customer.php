...
$this->db->query("DELETE FROM " . DB_PREFIX . "customer_authentication WHERE customer_id = '" . (int)$customer_id . "'"); //vqmod_d_social_login.xml
	...
	public function getCustomers($data = array()) {
        ...
        if (!empty($data['filter_customer_id'])) {
			$implode[] = "customer_id = " . $this->db->escape($data['filter_customer_id']);
		}
    ...
    public function getCompanies($customer_id) {
		$address_query = $this->db->query("SELECT company FROM " . DB_PREFIX . "address WHERE customer_id = '" . (int)$customer_id . "'");
		return ($address_query->num_rows)?$address_query->rows:false;
