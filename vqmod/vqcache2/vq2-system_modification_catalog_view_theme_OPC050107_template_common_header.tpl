...
<div class="pcontainer">
 ...
 <div class="pallet_custom_textarea pallet_addpalletnew_textarea"><?php echo $slider_addpallet_text; ?></div>
...
<div id="cartcontainer" class="cartcontainer"><div class="cart_contentcontainer">  <a href="javascript:void(0)" class="closebtn" onclick="closeWorksheetPanel()">×</a>  
<div class="cart_tabscol">
<i class="fa fa-trash-o deleteworkbookbtn" onclick="removeworkbook()"></i>
</div>
<div class="cart_selectedtab"></div>
<div class="cart_hd">
<h4>Edit Pallet Book</h4>
    ...
    <div class="cart_summary_data">
		...
		<div class="row">
			<div class="col-md-4 cart_summary_data_col">
				...
				<div class="price_subtotal">0</div>
			</div>
			<div class="col-md-4 cart_summary_data_col">
...
<div class="pallet_no_pallets pallet_add_cust">
	<h4><?php echo $slider_newclient_header; ?></h4>
	 <div class="pallet_custom_textarea pallet_newuseraddpallet_textarea"><?php echo $slider_newuseraddpallet_text; ?></div>
...
<div class="additional_action">
   ...
   <div class="floater" style="width: 210%; text-aling:left; white-space:nowrap;">
        ...
        <font class="pallet_bothvalid pallet_bothvalid_hdr"><?php echo trim($text_all_pallet_valid); ?> </font><font style="white-space: nowrap;"><i class="btn btn-green addpalletsbutton" onclick="newpalletpopup(); return false;"><i class="fa fa-plus-square"></i> <?php echo $button_create_pallet_modal; ?></i> <i class="btn btn-green checkoutbutton  ladda-button"  onclick="var l = Ladda.create(this);l.start();location.href='/index.php?route=pallet/worksheet/proceed'; return false;"><i class="fa fa-check-square-o"></i> <?php echo $button_proceed_checkout; ?><span class="ladda-label"></span><span class="ladda-spinner"></i></font>
		<i class="btn btn-green shopmorewine" onclick="closeWorksheetPanel(); return false;"><i class="fa fa-plus-square"></i> <?php echo $slider_shop_more; ?></i>
        </div>
<div class="pallet_add_cust" style="display: inline-block; width: 49%;" id="addpalletaction">
	<h4><?php echo $slider_newpallet_header; ?></h4>
    <div class="pallet_custom_textarea pallet_addpallet_textarea"><?php echo $slider_addpallet_text; ?></div>
    <div class="newp_buttons">
...
<ul class="list-inline"> 
 <li ><a class="home" href="<?php echo $home; ?>"> <i class="fa fa-home"></i> <?php echo $text_home; ?></a></li>
  ...
  <li style="display: none;"><a href="<?php echo $pallet_worksheet; ?>" title="<?php echo $text_pallet; ?>"><img class="pallet-icon" src="./image/demo-img/pallet.png"><span class="hidden-xs hidden-sm hidden-md"><?php echo $text_pallet; ?></span></a></li>
   <?php if ($logged) { ?>
   <li>
