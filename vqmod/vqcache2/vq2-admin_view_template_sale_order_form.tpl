...
$('#button-save').on('click', function() {
	...
	$.ajax({
		url: url,
		type: 'post',
		data: $('#tab-total select[name=\'order_status_id\'], #tab-total select, #tab-total textarea[name=\'comment\'], #tab-total input[name=\'update_currency\']:checked, #tab-total input[name=\'affiliate_id\']'),
		dataType: 'json',
		beforeSend: function() {
