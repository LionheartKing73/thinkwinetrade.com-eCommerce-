              ...
              <span class="price-old"><?php echo str_replace('<br/>','</span>&nbsp;<span class="price-new">',$product['price_cbr_all']); ?></span>
                 ...
                 <div class="product-details">
                            <div class="caption">                               
                                ...
                                <?php if ($product['price']) { ?>
                                <div class="price pro-price col-sm-12 ftrd">
                                    <?php if (!$product['special']) { ?>
                                    <div class="mainPrice">
                            ...
                            <div class="button-group">
                                <button type="button"  title="<?php echo $button_cart; ?>" data-toggle="tooltip" class="addtocart greenBtn" onclick="addproductaction('<?php echo $product['product_id']; ?>', '<?php echo str_replace("'", "\\'", $product['name']); ?>');"><span><?php echo $button_cart; ?></span></button>
