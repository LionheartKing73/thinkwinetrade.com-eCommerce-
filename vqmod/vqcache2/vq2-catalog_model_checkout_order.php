		...
		if ($order_info) {
			...
			//$this->sendSms($vemail->row['telephone'], $message);
                ...
                foreach($this->config->get('fob_margins') as $margin) {
                 ...
                 $hkd = $this->currency->format($product['price'],"HKD",$this->currency->getValue("HKD"));
                ...
                $data['totals'][] = array(
						'title' => "HKD",
						'text'  => $_COOKIE["additional_currency"],//str_replace(",", "",$this->currency->format($hkd_, "HKD", $this->currency->getValue("HKD"))),
					);
