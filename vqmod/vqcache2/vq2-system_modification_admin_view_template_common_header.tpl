...
function truncateOrders()
{
	if(confirm("This will truncate all orders! This operation is unreversable! Are you sure?") === true)
    {
   		$.ajax({
			  url: '/admin/index.php?route=sale/order/truncate&token=' + qs.token,
			  type: 'get',
			  complete: function() {
              	alert("Tables were truncated succesfully!");
			  }
		});
        return;
    }
...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
   <li><a onclick="truncateOrders(); return false;">Turncate order data</a></li>
