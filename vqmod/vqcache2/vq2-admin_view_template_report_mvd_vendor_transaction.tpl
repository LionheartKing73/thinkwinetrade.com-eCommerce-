            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
					...
					<td class="text-right"><?php echo $column_vunit_price; ?><?php echo ' (' . $config_currency . ')'; ?></td>
					...
					<td class="text-right"><?php echo $column_amount; ?><?php echo ' (HKD)'; ?></td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-right"><?php echo $order['vendor_price']; ?></td>
				  ...
				  <td class="text-right"><?php echo $order['amountHKD']; ?></td>
				  <td class="text-left">
