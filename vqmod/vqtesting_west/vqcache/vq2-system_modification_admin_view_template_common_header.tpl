...
<link type="text/css" href="view/stylesheet/fob_module.css" rel="stylesheet" media="screen" />
...
<?php } ?>
				...
				<script type="text/javascript">
				  var notificationurl = '<?php echo str_replace('&amp;', '&', $notificationurl) ?>';
				</script>
				<script src="view/javascript/notification.js" type="text/javascript"></script>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <img src="view/image/logo1.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" />
    </a>
    </div>
  <?php if ($logged) { ?>
  <ul class="nav pull-right">
  <li><a target="_blank" href="http://thinkwinetrade.com/sync/"><?php echo $sync_menu; ?></a></li>

    <?php if (isset($_langs) && count((array)$_langs) > 1) { ?>
    <li>
      <form action="<?php echo $switch_language; ?>" method="post" enctype="multipart/form-data" id="lang-switcher" style="margin:0;padding:4px 15px;display:block;">
        <select name="cual_admin_language_id" id="cual_admin_language_id" data-toggle="tooltip" data-placement="bottom" title="<?php echo $text_switch_language; ?>" style="width:auto;" class="form-control">
          <?php foreach((array)$_langs as $l) { ?>
          <option value="<?php echo $l['language_id']; ?>"<?php echo ($l['language_id'] == $config_language_id) ? ' selected' : ''; ?>><?php echo $l['name']; ?></option>
          <?php } ?>
        </select>
      </form>
    </li>
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li><a href="<?php echo $rating; ?>"><span class="label label-danger pull-right"><?php echo $rating_total; ?></span>Ratings</a></li>
		<li class="divider"></li>
