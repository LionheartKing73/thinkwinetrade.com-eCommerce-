...
*/
	...
	/*	
        ...
        if (isset($this->request->post['product_attribute'])) {
            ...
            if (isset($this->request->get['product_id'])) {
                $product_attributes_vals = $this->model_catalog_vdi_product->getProductAttributes($this->request->get['product_id']);
            } 
            
            $product_attributes = $this->model_catalog_attribute->getAttributesListing();
        }
        ...
        foreach ($product_attributes as $product_attribute) {
            ...
            if ($attribute_info) {
                ...
                if(isset($this->request->get['product_id']) && !isset($this->request->post['product_attribute'])) { 
                    $value_id = $this->recursive_array_search($product_attribute['attribute_id'], $product_attributes_vals);
                    if ($value_id === false)
                       $descriptiom = '';
                    else
                      $description = $product_attributes_vals[$value_id]['product_attribute_description'][$language_id]['text'];
                   
                } else {
                    $description = isset($product_attribute['attribute_description']) ? $product_attribute['attribute_description'] : '';
                }
                ...
                $data['product_attributes'][] = array(
                    ...
                    'values'                        => isset($attribute_info['values']) ? $attribute_info['values'] : array(),
                    'ranges'                        => isset($attribute_info['ranges']) ? $attribute_info['ranges'] : array(),
                    'type'                          => $this->model_catalog_attribute->getAttributeType($attribute_info['attribute_type'])
                );
            }
